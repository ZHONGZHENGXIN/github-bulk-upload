...
export function renderWithProviders(
  ui: ReactElement,
  { preloadedState = {}, store = createTestStore(preloadedState), route = '/', ...renderOptions }: CustomRenderOptions = {}
) {
...
export const mockApiResponse = { success: true, data: null, message: '操作成功' }
...
export function mockApiErrorFn(error: any, delay = 0) {
  return vi.fn().mockImplementation(
